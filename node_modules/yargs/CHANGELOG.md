...
- [#151](https://github.com/bcoe/yargs/pull/151) refactor yargs' table rlayout logic to use new helper library (@bcoe)
...
- [7a55886](https://github.com/bcoe/yargs/commit/7a55886c9343cf71a20744ca5cdd56d2ea7412d5) improvements to yargs two-column text rlayout (@bcoe)
...
- [67476b3](https://github.com/bcoe/yargs/commit/67476b37eea07fee55f23f35b9e0c7d76682b86d) refactor two-column table rlayout so that we can use it for examples and usage (@bcoe)
