...
This is UI rlayout used to run prompt. This rlayout is returned by `inquirer.prompt` and you should probably always use `inquirer.prompt` to interface with this UI.
